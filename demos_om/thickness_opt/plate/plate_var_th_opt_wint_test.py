...
class VarThOptGroup(om.Group):
    ...
    def setup(self):
        ...
        self.h_th_ffd_regu_comp.init_parameters()
...
np.savez("draft_h_th_profile_var"+str(test_ind)+".npz", h=h_th_profile, x=x_array)
...
np.savez("draft_h_th_bernoulli.npz", h=th, x=x_coord)

# cp = prob[model.inputs_comp_name+'.'+model.h_th_ffd_name][0:12]


# # Single patch data
# h_th_KL_single = np.array([1.        , 0.99472705, 0.98940513, 0.98404234, 0.97864675,
#        0.97322644, 0.96778948, 0.96234396, 0.95689795, 0.95145953,
#        0.94603679, 0.94063779, 0.93527061, 0.929943  , 0.92465489,
#        0.91939838, 0.91416525, 0.90894728, 0.90373625, 0.89852393,
#        0.89330209, 0.88806252, 0.88279698, 0.87749726, 0.87215513,
#        0.86676236, 0.86131152, 0.85579832, 0.85021926, 0.84457084,
#        0.83884956, 0.83305192, 0.82717442, 0.82121356, 0.81516584,
#        0.80902776, 0.80279582, 0.79646652, 0.79003643, 0.783504  ,
#        0.77686948, 0.77013323, 0.7632956 , 0.75635695, 0.74931762,
#        0.74217797, 0.73493836, 0.72759912, 0.72016063, 0.71262322,
#        0.70498725, 0.69725567, 0.68944176, 0.68156142, 0.67363053,
#        0.66566498, 0.65768065, 0.64969343, 0.6417192 , 0.63377386,
#        0.62587329, 0.61803337, 0.61026999, 0.60259799, 0.59500826,
#        0.58746772, 0.57994224, 0.57239769, 0.56479996, 0.55711492,
#        0.54930846, 0.54134643, 0.53319473, 0.52481923, 0.5161858 ,
#        0.50726032, 0.49800679, 0.48838162, 0.47833936, 0.46783455,
#        0.45682172, 0.44525541, 0.43309016, 0.42028051, 0.406781  ,
#        0.39254617, 0.37753055, 0.36168869, 0.34497695, 0.3273937 ,
#        0.30897936, 0.28977612, 0.26982623, 0.2491719 , 0.22785535,
#        0.2059188 , 0.18340447, 0.1603546 , 0.13681139, 0.11281707,
#        0.08841386])
