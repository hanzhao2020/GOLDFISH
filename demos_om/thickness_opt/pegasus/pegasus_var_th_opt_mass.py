...
nonmatching_opt.set_multiFFD_surf_inds([ffd0_surf_inds, ffd1_surf_inds,
                                        ffd2_surf_inds, ffd3_surf_inds])
num_ffd_blocks = nonmatching_opt.num_ffd_blocks
cp_ffd_lims_multiffd = nonmatching_opt.cpsurf_lims_multiffd
...
nonmatching_opt.set_multiFFD(ffd_knots_list, ffd_control_list)
