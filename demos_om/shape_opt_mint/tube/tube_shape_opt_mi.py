...
class ShapeOptGroup(om.Group):
    ...
    def init_parameters(self):
        ...
        self.design_var_lower = [-1.e-3, -1.e-3] # x min, z min
        self.design_var_upper = [1.2, 1.2] # x max, z max
...
# nonmatching_opt.set_shopt_align_CP(align_surf_inds=[[0,1],[0,1]],
#                                    align_dir=[[1],[1]])
# nonmatching_opt.set_shopt_pin_CP(self, pin_surf_inds=[0,1], 
#                                  pin_dir=[0,0], pin_side=[1,1], 
...
p_list_y = [[3,1],]*len(shopt_surf_inds[1])

init_p_list = [p_list_x, p_list_y]
init_knots_list = []
...
t00 = cpsurfd2a.set_cp_align(field=0, align_dir_list=[1,1])
t01 = cpsurfd2a.set_cp_align(field=1, align_dir_list=[1,1])


t10 = cpsurfd2a.set_cp_pin(field=0, pin_dir0_list=[0,0], 
                           pin_side0_list=[[0], [1]])
t11 = cpsurfd2a.set_cp_pin(field=1, pin_dir0_list=[0,0], 
                           pin_side0_list=[[0], [1]])
