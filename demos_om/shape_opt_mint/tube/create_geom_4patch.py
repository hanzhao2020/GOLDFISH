...
if __name__ == '__main__':
    ...
    pts0 = [[0., w, 0.], [w/2+h, w/2, 0.], 
            [0., w, L*L_coeff0], [w/2+h, w/2, L*L_coeff0]]
    pts1 = [[0., w, L*L_coeff0], [w/2+h, w/2, L*L_coeff0], 
            [0., w, L], [w/2+h, w/2, L]]
    pts2 = [[w/2, w/2+h, 0.], [w, 0., 0.], 
            [w/2, w/2+h, L*L_coeff1], [w, 0., L*L_coeff1]]
    pts3 = [[w/2, w/2+h, L*L_coeff1], [w, 0., L*L_coeff1], 
            [w/2, w/2+h, L], [w, 0., L]]
    ...
    srf2 = create_surf(pts2, num_el2x, num_el2y, p2)
    srf3 = create_surf(pts3, num_el3x, num_el3y, p3)
    ...
    write_geom_file(occ_surf_list, "./geometry/init_tube_geom_4patch.igs")