...
filename_igs = "./geometry/init_arch_geom_2patch.igs"
...
a0 = nonmatching_opt.set_shopt_regu_CP_multiFFD(shopt_regu_dir_list=[[None, None], 
                                           ...
                                           shopt_regu_side_list=[[None, None], 
                                                                 [None, None]])
a1 = nonmatching_opt.set_shopt_pin_CP_multiFFD(0, pin_dir0_list=[2, 2], 
                                          pin_side0_list=[[0], [0]],
                                          pin_dir1_list=None, 
                                          pin_side1_list=None)
a2 = nonmatching_opt.set_shopt_pin_CP_multiFFD(2, pin_dir0_list=[2, 2], 
                                          pin_side0_list=[[0], [0]],
                                          pin_dir1_list=None, 
                                          pin_side1_list=None)
