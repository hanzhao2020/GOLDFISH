...
VTKWriter().write('./geometry/FFD_block_initial0.vtk', FFD_block, ref_level=5)
VTKWriter().write_cp('./geometry/FFD_block_cp_initial0.vtk', FFD_block)


FFD_block1 = shopt_ffd_block_list[1].copy()
# VTK().write("./geometry/FFD_block_initial1.vtk", FFD_block1)
VTKWriter().write('./geometry/FFD_block_initial1.vtk', FFD_block1, ref_level=5)
VTKWriter().write_cp('./geometry/FFD_block_cp_initial1.vtk', FFD_block1)
...
final_cpffd0 = prob[model.cpffd_design2full_comp_name+'.'+model.cpffd_full_name_list[0]][0:100]
final_cpffd[:,0] = final_cpffd0
final_cpffd1 = prob[model.cpffd_design2full_comp_name+'.'+model.cpffd_full_name_list[1]][0:100]
...
VTKWriter().write('./geometry/FFD_block_final0.vtk', final_FFD_block, ref_level=5)
VTKWriter().write_cp('./geometry/FFD_block_cp_final0.vtk', final_FFD_block)


init_cpffd1 = FFD_block1.control[:,:,:,0:3].transpose(2,1,0,3).reshape(-1,3)
final_cpffd1 = init_cpffd1.copy()

final_cpffd10 = prob[model.cpffd_design2full_comp_name+'.'+model.cpffd_full_name_list[0]][100:]
final_cpffd1[:,0] = final_cpffd10
final_cpffd11 = prob[model.cpffd_design2full_comp_name+'.'+model.cpffd_full_name_list[1]][100:]
final_cpffd1[:,1] = final_cpffd11
final_cpffd1 = final_cpffd1.reshape(FFD_block1.control[:,:,:,0:3]\
              .transpose(2,1,0,3).shape)
final_cpffd1 = final_cpffd1.transpose(2,1,0,3)
final_FFD_block1 = NURBS(FFD_block1.knots, final_cpffd1)
VTKWriter().write('./geometry/FFD_block_final1.vtk', final_FFD_block1, ref_level=5)
VTKWriter().write_cp('./geometry/FFD_block_cp_final1.vtk', final_FFD_block1)

# for i in range(len(preprocessor.intersections_phy_coords)):
#     mesh_phy = generate_mortar_mesh(preprocessor.intersections_phy_coords[i], num_el=128)
#     File('./geometry/int_curve_'+str(i)+'.pvd') << mesh_phy
