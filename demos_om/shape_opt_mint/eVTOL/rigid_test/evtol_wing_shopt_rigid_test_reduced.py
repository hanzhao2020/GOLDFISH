...
# h_th[5:] = [Constant(5.0e-3)]*(num_surfs-5)
...
t00 = cpsurfd2a.set_cp_align(field=0, align_dir_list=[[0,1],]*len(shopt_surf_inds[0]))
t01 = cpsurfd2a.set_cp_align(field=1, align_dir_list=[[0,1],]*len(shopt_surf_inds[1]))

# t10 = cpsurfd2a.set_cp_pin(field=0, pin_dir0_list=[0,0], 
#                           pin_side0_list=[[0,1], [0,1]])

# t2 = cpsurfd2a.set_cp_regu(2, regu_dir_list=[1,1,1], rev_dir=True)
t30 = cpsurfd2a.set_cp_dist(0, surf_inds=[3,4])
# t31 = cpsurfd2a.set_cp_dist(1, surf_inds=[5,6])
