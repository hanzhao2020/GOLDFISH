...
class ShapeOptGroup(om.Group):
    ...
    def setup(self):
       ...
       #  self.init_val_list = [np.array([4.80982421, 5.20982421]), 
       #                   np.array([0.97790126, 2.05509165, 2.76051899, 3.44054622, 4.15867335,
       # 4.87680054]), 
       #                   np.array([3.17074929, 3.32554213, 3.48634519, 3.64427782, 2.99260626,
       # 3.16876128, 3.34323321, 3.51619121, 3.15090334, 3.31099276,
       # 3.47841159, 3.6409868 , 3.01389163, 3.18440665, 3.35303393,
       # 3.52065146, 3.19541864, 3.2444316 , 3.19999592, 3.1470911 ,
       # 3.04738345, 3.02912308, 3.06455686, 3.09096056, 3.30142581,
       # 3.35160231, 3.30144621, 3.25568851, 3.16566386, 3.14833648,
       # 3.18183963, 3.2064283 , 3.37141229, 3.41933609, 3.37134296,
       # 3.32761958, 3.24274927, 3.22614314, 3.25821389, 3.28163276,
       # 3.43959795, 3.48519317, 3.43958538, 3.39799864, 3.316582  ,
       # 3.30081697, 3.33128613, 3.35360686, 3.51202352, 3.55507005,
       # 3.51215385, 3.47292462, 3.39427337, 3.37947948, 3.40813144,
       # 3.4293083 , 3.58444052, 3.62494316, 3.58471105, 3.54783538,
       # 3.47197103, 3.45814316, 3.48498504, 3.50501522])]

        self.init_val_list = self.init_cp_design
        self.init_val_list[0] = [4.67, 5.50]
...
# h_th = [Constant(1.0e-3)]*num_surfs  # Thickness of surfaces, m
# h_th[3:] = [Constant(5.0e-3)]*(num_surfs-3)
