...
class ShapeOptGroup(om.Group):
    ...
    def setup(self):
        ...
        self.add_constraint(self.volume_comp_name+'.'+self.volume_name,
                            # equals=self.vol_val)
                            lower=self.vol_val*0.7,
                            upper=self.vol_val*1.3)
...
shopt_multi_ffd_inds = [[0,1,2], [3,4], list(arange(5,preprocessor.num_surfs))]
...
shopt_ffd_num_el = [[1,1,1], [1,1,1], [4,1,1]]
shopt_ffd_p = [[1,1,1],[1,1,1],[1,2,1]]
extrude_dir = [2,1,0]
extrude_coeff = 0.05
...
a0 = nonmatching_opt.set_shopt_regu_CP_multiFFD(shopt_regu_dir_list=[[None,None,None], 
                                           ...
                                           shopt_regu_side_list=[[None,None,None], 
                                                                [None, None, None],
                                                                [None, None, None]])
a1 = nonmatching_opt.set_shopt_pin_CP_multiFFD(0, pin_dir0_list=['whole', None, None], 
                                          pin_side0_list=None,
                                          pin_dir1_list=None, 
                                          pin_side1_list=None)
a2 = nonmatching_opt.set_shopt_pin_CP_multiFFD(1, pin_dir0_list=['whole', None, None], 
                                          pin_side0_list=None,
                                          pin_dir1_list=None, 
                                          pin_side1_list=None)
a3 = nonmatching_opt.set_shopt_pin_CP_multiFFD(2, pin_dir0_list=['whole', None, None], 
                                          pin_side0_list=None,
                                          pin_dir1_list=None, 
                                          pin_side1_list=None)
