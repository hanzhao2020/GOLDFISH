...
# opt_field = [0,1,2]
# opt_surf_inds = [3]
# nonmatching_opt.set_shopt_FFD_surf_inds(opt_field, opt_surf_inds)


# shopt_ffd_p = [2,2,2]
# shopt_ffd_num_el = [1,3,1]
...
# a0 = nonmatching_opt.set_shopt_align_CPFFD(align_dir=[[1,2], [0,2], [0]])
# a1 = nonmatching_opt.set_shopt_pin_CPFFD(pin_dir0=[1, 1, 1],
#                                          pin_side0=[[0], [0], [0]],
#                                          pin_dir1=[None, None],
#                                          pin_side1=[None, None])
...
shopt_multi_ffd_inds = [[0,1,2], [3,4]]
