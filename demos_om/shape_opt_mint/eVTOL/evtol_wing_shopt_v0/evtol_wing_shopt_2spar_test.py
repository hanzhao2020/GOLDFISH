...
from create_geom_evtol_2spar import preprocessor
...
class ShapeOptGroup(om.Group):
    ...
    def setup(self):
        ...
        self.shell_dist_comp = ShellDistComp(dist_dir=0, rev_dir=True,
                    input_cp_design_name_pre=self.cpsurf_iga_design_name_pre,
        ...
        self.shell_dist_cons_val = np.zeros(self.shell_dist_comp.output_shape)*3e-2
        ...
        self.connect(self.inputs_comp_name+'.'
                     +self.cpsurf_iga_design_name_list[0],
                     self.shell_dist_comp_name+'.'
                     +self.cpsurf_iga_design_name_pre+str(0))
        ...
        self.add_constraint(self.shell_dist_comp_name+'.'
                            +self.cpsurf_dist_name_pre+str(0),
...
t0 = cpsurfd2a.set_cp_align(0, [1,1])
t1 = cpsurfd2a.set_cp_regu(2, [1,1], rev_dir=True)
