...
from shell_dist_comp import ShellDistComp
...
class ShapeOptGroup(om.Group):
    ...
    def init_parameters(self):
        ...
        self.cpsurf_dist_name_pre = 'CP_dist'
        ...
        self.init_cp_design[0] = np.array([self.init_cp_design0[0][0]])

        self.input_cp_shapes = [len(cp) for cp in self.init_cp_design]

        # self.design_var_lower = [3.8, 0.53, 2.7] # x min, z min
        # self.design_var_upper = [5.6, 5.3, 3.7] # x max, z max

        self.design_var_lower = [0.53, 2.7] # x min, z min
        self.design_var_upper = [5.3, 3.7] # x max, z max
        ...
        # self.shell_dist_comp_name = 'shell_dist_comp'
    ...
    def setup(self):
        ...
        # self.shell_dist_dir = 1
        # self.shell_dist_comp = ShellDistComp(dist_dir=self.shell_dist_dir, cp_size=3,
        #                                      num_surfs=3, rev_dir=True,
        #             input_cp_design_name_pre=self.cpsurf_iga_design_name_pre,
        #             output_cp_dist_name_pre=self.cpsurf_dist_name_pre)
        # self.shell_dist_comp.init_parameters()
        # self.add_subsystem(self.shell_dist_comp_name, self.shell_dist_comp)
        # self.shell_dist_cons_val = np.zeros(self.shell_dist_comp.output_shape)*5e-2
        ...
        # field_ind = self.opt_field.index(self.shell_dist_dir)
        # self.connect(self.inputs_comp_name+'.'
        #              +self.cpsurf_iga_design_name_list[field_ind],
        #              self.shell_dist_comp_name+'.'
        #              +self.cpsurf_iga_design_name_pre+str(self.shell_dist_dir))
        ...
        # self.add_constraint(self.shell_dist_comp_name+'.'
        #                     +self.cpsurf_dist_name_pre+str(self.shell_dist_dir),
        #                     lower=self.shell_dist_cons_val)
        ...
        self.add_constraint(self.volume_comp_name+'.'+self.volume_name,
                            # equals=self.vol_val)
                            lower=self.vol_val*0.5, upper=self.vol_val*5)
...
# opt_field = [0,1,2]
opt_field = [1,2]
# shopt_surf_inds = [[3,4,5], [3,4,5], [3,4,5]]
shopt_surf_inds = [[3,], [3,]]
...
# t00 = cpsurfd2a.set_cp_align(0, [1])
t01 = cpsurfd2a.set_cp_align(1, [1])
# t10 = cpsurfd2a.set_cp_regu(0, [0], rev_dir=False)
t11 = cpsurfd2a.set_cp_regu(2, [1], rev_dir=True)
