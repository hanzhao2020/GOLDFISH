...
class ShapeOptGroup(om.Group):
    ...
    def init_parameters(self):
        ...
        self.design_var_lower = [3.6, -0.5, 2.0] # x-lower, z-lower
        self.design_var_upper = [6.0, 5.2, 4.0] # x-upper, z-upper
...
# a0 = nonmatching_opt.set_shopt_align_CPFFD(align_dir=[[1, 2], [0]])
a0 = nonmatching_opt.set_shopt_align_CPFFD(align_dir=[[2], [0,2], None])
# a0 = nonmatching_opt.set_shopt_align_CPFFD(align_dir=[[1, 2], None])
# a1 = nonmatching_opt.set_shopt_pin_CPFFD(pin_dir0=[None, None],
#                                          pin_side0=[None, None],
#                                          pin_dir1=[None, None],
#                                          pin_side1=[None, None])
...
for i, field in enumerate([0,1,2]):
