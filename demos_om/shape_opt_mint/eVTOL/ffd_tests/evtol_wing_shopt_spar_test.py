...
from create_geom_evtol_wspars import preprocessor
...
class ShapeOptGroup(om.Group):
    ...
    def init_parameters(self):
        ...
        self.design_var_lower = [1.0, 2.0] # x-lower, z-lower
        self.design_var_upper = [8.0, 4.0] # x-upper, z-upper
    ...
    def setup(self):
        ...
        self.cpffd_regu_lower_val = [2.e-2, 2.e-2]
