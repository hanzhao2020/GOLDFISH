...
filename_igs = "/Users/hanzhao/OneDrive/github/GOLDFISH/demos_om/shape_opt_mint/eVTOL/geometry/eVTOL_wing_structure.igs"
...
# r11 = lower_skin_surf_ik_control[:,:,0][0][-1]/lower_skin_surf_ik_control[:,:,0][1][-1]
# r21 = lower_skin_surf_ik_control[:,:,0][0][-1]/lower_skin_surf_ik_control[:,:,0][2][-1]
# # xp = [0,1]
# xp1 = [lower_skin_surf_ik_control[:,:,0][1][0], lower_skin_surf_ik_control[:,:,0][1][-1]]
# xp2 = [lower_skin_surf_ik_control[:,:,0][2][0], lower_skin_surf_ik_control[:,:,0][2][-1]]
# fp1 = [1.03,r11]
# fp2 = [1.05,r21]
# r1 = np.interp(lower_skin_surf_ik_control[:,:,0][1][::-1], xp1[::-1], fp1[::-1])[::-1]
# r2 = np.interp(lower_skin_surf_ik_control[:,:,0][2][::-1], xp2[::-1], fp2[::-1])[::-1]

# for i in range(1, len(lower_skin_surf_ik_control[:,:,0])):
#     if i == 1:
#         r = r1
#     else:
#         r = r2
#     lower_skin_surf_ik_control[:,:,0][i] = lower_skin_surf_ik_control[:,:,0][i]*r
...
# VTK().write("./geometry/outer_surf_lower.vtk", lower_skin_surf_ik)
# VTK().write("./geometry/outer_surf_uppper.vtk", upper_skin_surf_ik)
# VTK().write("./geometry/outer_surf_tip_.vtk", wing_tip_surf_ik)
...
for int_ind in range(preprocessor.num_intersections_all):
    ...
    if 'skin' in s_name0:
        ...
        if 'rib' in s_name1: # Requires to be 'surf-edge'
            ...
            #     xi1_type = int_xi_type[np.argmin(err_norm1)]
            #     int_xi_new = int_xi.split('-')[0]+'-'+xi1_type
            if int_type == 'surf-edge' or int_type == 'edge-surf':
