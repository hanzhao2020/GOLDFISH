...
u_insert_list = [16, 14, 1] \
              + [16]*num_spars + [4]*num_ribs
v_insert_list = [8, 7, 12] \
              + [1]*num_spars + [1]*num_ribs
...
wing_surf_names = ['skin_l', 'skin_u', 'tip',
                   'spar_f', 'spar_r']
wing_surf_names += ['rib_'+str(i) for i in range(preprocessor.num_surfs-5)]
...
# preprocessor.intersections_type[-1] = ['surf-surf', 'na']
