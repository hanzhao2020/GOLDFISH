...
class CPIGA2XiCoarseComp(om.ImplicitComponent):
    ...
    def init_parameters(self):
        ...
        self.cpiga2xi_imop = CPIGA2XiCoarseImOperation(self.nonmatching_opt)
...
if __name__ == "__main__":
    ...
    prob = Problem()
    comp = CPIGA2XiCoarseComp(nonmatching_opt=nonmatching_opt)
