...
from max_int_xi_exop import *

class MaxIntXiComp(om.ExplicitComponent):
    ...
    def initialize(self):
        ...
        self.options.declare('output_name', default='max_xi')
    ...
    def init_parameters(self):
        ...
        self.max_int_xi_exop = MaxIntXiExop(self.nonmatching_opt,
                                            self.rho, self.method)
        self.init_xi = get_petsc_vec_array(self.nonmatching_opt.xi_nest)
        self.input_shape = self.max_int_xi_exop.xi_size
    ...
    def compute(self, inputs, outputs):
        ...
        outputs[self.output_name] = self.max_int_xi_exop.max_xi(xi_array)
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials[self.output_name, self.input_xi_name] = \
            self.max_int_xi_exop.derivative(xi_array)
...
if __name__ == "__main__":
    ...
    prob = Problem()
    comp = MaxIntXiComp(nonmatching_opt=nonmatching_opt_ffd)
