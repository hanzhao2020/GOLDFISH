...
a0 = nonmatching_opt.set_shopt_multiFFD(opt_field, shopt_ffd_knots_list, 
                                        shopt_ffd_control_list)

a2 = nonmatching_opt.get_init_CPFFD_multiFFD(field=0)
a3 = nonmatching_opt.get_init_CPFFD_multiFFD(field=2)
