...
class CPFFDAlignModel(Model):

    def initialize(self):
        self.parameters.declare('nonmatching_opt_ffd')
        self.parameters.declare('input_cpffd_name_pre', 
                                default='CP_FFD')
    ...
    def init_paramters(self):
        ...
        self.output_cpalign_name_pre = \
            self.parameters['output_cpalign_name_pre']
        self.op = CPFFDAlignOperation(
    ...
    def define(self):
        ...
        for i, field in enumerate(self.op.opt_field):
            self.register_output(self.op.output_cpalign_name_list[i],
            cpffd_align_list[i])


class CPFFDAlignOperation(CustomExplicitOperation):
    ...
    def define(self):
        for i, field in enumerate(self.opt_field):
            ...
            self.declare_derivatives(self.output_cpalign_name_list[i],
